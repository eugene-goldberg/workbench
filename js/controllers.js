...
function datatablesCtrl($scope,DTOptionsBuilder, $http){
    ...
    $scope.datasets = [
        {
            ...
            tags: 'sales, marketting',
            location: 'on-prem Hadoop'
        },
        {
    ...
    $scope.showSelectedDataSet = function(){
        console.log("selected dataset:  " + $scope.selectedDataSet);
    };

    $scope.selectedDataset = undefined;

    $scope.getSelected = function () {
        var ar = $scope.datasets.filter(
            function (value) {
                if (value.checked == 1) {
                    return true;
                } else {
        ...
        $scope.selectedDataset = ar;
        console.log($scope.selectedDataset);
        return ar;
    };

    $scope.sendPost = function(){
        $http.post("/startsession", JSON.stringify($scope.selectedDataset)).success(function(data,status) {
        })
    };
